...
public class CardController {
    ...
    public ResponseEntity<String> deleteCart(@RequestBody DeleteCardRequest deleteCardRequest) {
        if(deleteCardRequest.getCardId()==null){
            throw new RuntimeException("CardId not found");
        }
        cardService.deleteCard(deleteCardRequest.getCardId());
        return ResponseEntity.ok("Cart deleted successfull: " );
    }
}
